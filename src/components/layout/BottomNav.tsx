...
import { BottomNavProps } from "../../interfaces/layoutInterfaces";
import BottomNavOptions from "./BottomNavOptions";

const BottomNav: React.FC<BottomNavProps> = ({ page }) => {
  return (
    <nav className="fixed bottom-0 left-0 w-full bg-neutral-100 border-t p-2 flex justify-around lg:hidden">
